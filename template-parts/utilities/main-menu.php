<?php if (have_rows('mega_menu_items', 'option')) : ?>
  <nav class="main-menu hidden xl:block mr-4">
      ...
      <?php while (have_rows('mega_menu_items', 'option')) : the_row(); ?>
        ...
        <li class="relative group">
          <a href="<?php echo $menu_item['url'] ?>" class="flex items-center whitespace-nowrap text-sm 2xl:text-base py-4 text-black hover:text-primary transition-colors font-medium">
            ...
            <?php if ($has_submenu): ?>
               <svg class="ml-1 w-4 h-4 transition-transform group-hover:-rotate-180" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
            <?php endif; ?>
          </a>
            ...
            <div class="absolute left-0 top-full hidden group-hover:block w-64 pt-0">
              <ul class="bg-white border border-gray-100 shadow-xl z-50 py-2 rounded-md">
                <?php while (have_rows('submenu')) : the_row(); ?>
                  ...
                  ?>
                  <li class="relative <?php if ($has_sub_submenu) { echo 'has-subsubmenu'; } ?>">
                    <a href="<?php echo $submenu_item['url'] ?>" class="flex justify-between items-center w-full px-6 py-2.5 text-black hover:bg-gray-50 hover:text-primary transition-colors text-sm">
                      ...
                      <?php if ($has_sub_submenu): ?>
                         <svg class="w-4 h-4 text-gray-400 -mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" /></svg>
                      <?php endif; ?>
                    </a>
