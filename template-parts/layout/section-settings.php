...
$loop_icon_overlay = $section_settings['loop_icon_overlay'];
$loop_overlay_tr_active = $loop_icon_overlay['top_right']['activate'];
$loop_overlay_tr = '';
...
$loop_overlay_br_active = $loop_icon_overlay['bottom_right']['activate'];
$loop_overlay_br = '';
